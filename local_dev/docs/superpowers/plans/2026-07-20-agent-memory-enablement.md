...
- Do not create product memory directories, launch either agent, generate memory, delete memory, or touch session files.
...
- Create at execution time: `/private/tmp/agent-memory-enable-8a1b944/` — permission-preserving rollback copies and before/after file manifests. Keep it after success for recoverability.
...
- Create: `/private/tmp/agent-memory-enable-8a1b944/default-codex.toml`
- Create: `/private/tmp/agent-memory-enable-8a1b944/orca-codex.toml`
- Create: `/private/tmp/agent-memory-enable-8a1b944/claude-settings.json`
- Create: `/private/tmp/agent-memory-enable-8a1b944/*.before` and `*.after` verification manifests
...
- [ ] **Step 2: Create permission-preserving backups and immutable-state manifests**

Run:

```bash
test ! -e /private/tmp/agent-memory-enable-8a1b944
mkdir -m 700 /private/tmp/agent-memory-enable-8a1b944
cp -p /Users/hyun/.codex/config.toml /private/tmp/agent-memory-enable-8a1b944/default-codex.toml
cp -p '/Users/hyun/Library/Application Support/orca/codex-runtime-home/home/config.toml' /private/tmp/agent-memory-enable-8a1b944/orca-codex.toml
cp -p /Users/hyun/.claude/settings.json /private/tmp/agent-memory-enable-8a1b944/claude-settings.json
find /Users/hyun/.codex/sessions '/Users/hyun/Library/Application Support/orca/codex-runtime-home/home/sessions' -type f -exec stat -f '%N|%z|%m' {} + 2>/dev/null | LC_ALL=C sort > /private/tmp/agent-memory-enable-8a1b944/codex-sessions.before
find /Users/hyun/.claude/projects -type f ! -path '*/memory/*' -exec stat -f '%N|%z|%m' {} + 2>/dev/null | LC_ALL=C sort > /private/tmp/agent-memory-enable-8a1b944/claude-sessions.before
find /Users/hyun/.claude/projects -type f -path '*/memory/*' -exec stat -f '%N|%z|%m' {} + 2>/dev/null | LC_ALL=C sort > /private/tmp/agent-memory-enable-8a1b944/claude-memory.before
stat -f '%OLp' /Users/hyun/.codex/config.toml > /private/tmp/agent-memory-enable-8a1b944/default-codex.mode.before
stat -f '%OLp' '/Users/hyun/Library/Application Support/orca/codex-runtime-home/home/config.toml' > /private/tmp/agent-memory-enable-8a1b944/orca-codex.mode.before
stat -f '%OLp' /Users/hyun/.claude/settings.json > /private/tmp/agent-memory-enable-8a1b944/claude-settings.mode.before
```
...
Build and compare preservation manifests:

```bash
find /Users/hyun/.codex/sessions '/Users/hyun/Library/Application Support/orca/codex-runtime-home/home/sessions' -type f -exec stat -f '%N|%z|%m' {} + 2>/dev/null | LC_ALL=C sort > /private/tmp/agent-memory-enable-8a1b944/codex-sessions.after
find /Users/hyun/.claude/projects -type f ! -path '*/memory/*' -exec stat -f '%N|%z|%m' {} + 2>/dev/null | LC_ALL=C sort > /private/tmp/agent-memory-enable-8a1b944/claude-sessions.after
find /Users/hyun/.claude/projects -type f -path '*/memory/*' -exec stat -f '%N|%z|%m' {} + 2>/dev/null | LC_ALL=C sort > /private/tmp/agent-memory-enable-8a1b944/claude-memory.after
stat -f '%OLp' /Users/hyun/.codex/config.toml > /private/tmp/agent-memory-enable-8a1b944/default-codex.mode.after
stat -f '%OLp' '/Users/hyun/Library/Application Support/orca/codex-runtime-home/home/config.toml' > /private/tmp/agent-memory-enable-8a1b944/orca-codex.mode.after
stat -f '%OLp' /Users/hyun/.claude/settings.json > /private/tmp/agent-memory-enable-8a1b944/claude-settings.mode.after
cmp /private/tmp/agent-memory-enable-8a1b944/codex-sessions.before /private/tmp/agent-memory-enable-8a1b944/codex-sessions.after
cmp /private/tmp/agent-memory-enable-8a1b944/claude-sessions.before /private/tmp/agent-memory-enable-8a1b944/claude-sessions.after
cmp /private/tmp/agent-memory-enable-8a1b944/claude-memory.before /private/tmp/agent-memory-enable-8a1b944/claude-memory.after
cmp /private/tmp/agent-memory-enable-8a1b944/default-codex.mode.before /private/tmp/agent-memory-enable-8a1b944/default-codex.mode.after
cmp /private/tmp/agent-memory-enable-8a1b944/orca-codex.mode.before /private/tmp/agent-memory-enable-8a1b944/orca-codex.mode.after
cmp /private/tmp/agent-memory-enable-8a1b944/claude-settings.mode.before /private/tmp/agent-memory-enable-8a1b944/claude-settings.mode.after
```

Expected: all six `cmp` commands exit `0` with no output. Keep `/private/tmp/agent-memory-enable-8a1b944/` after success as a recoverable backup and report its path.
...
```bash
cp -p /private/tmp/agent-memory-enable-8a1b944/default-codex.toml /Users/hyun/.codex/config.toml
cp -p /private/tmp/agent-memory-enable-8a1b944/orca-codex.toml '/Users/hyun/Library/Application Support/orca/codex-runtime-home/home/config.toml'
cp -p /private/tmp/agent-memory-enable-8a1b944/claude-settings.json /Users/hyun/.claude/settings.json
env CODEX_HOME=/Users/hyun/.codex /opt/homebrew/bin/codex features list | rg '^memories[[:space:]]'
env CODEX_HOME='/Users/hyun/Library/Application Support/orca/codex-runtime-home/home' /opt/homebrew/bin/codex features list | rg '^memories[[:space:]]'
/usr/bin/jq '{autoMemoryEnabled, autoMemoryDirectory}' /Users/hyun/.claude/settings.json
```
...
Session contents changed: no
Rollback backup: /private/tmp/agent-memory-enable-8a1b944
