class Dotsync < Formula
  ...
  url "https://github.com/changja88/homebrew-dotsync/archive/refs/tags/v0.1.29.tar.gz"
  sha256 "4382fb917eec513f33e356b1eddf73110dea45db444f8db70b5b60745c9addf2"
  license "MIT"
  ...
  test do
    assert_match "dotsync 0.1.29", shell_output("#{bin}/dotsync --version")
  end
end
