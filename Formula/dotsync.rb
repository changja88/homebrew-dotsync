class Dotsync < Formula
  ...
  url "https://github.com/changja88/homebrew-dotsync/archive/refs/tags/v0.1.6.tar.gz"
  sha256 "db76f6308e505fc5549e92b60d66323b9414ce81f06828f027014cff590824e6"
  license "MIT"
  ...
  test do
    assert_match "dotsync 0.1.6", shell_output("#{bin}/dotsync --version")
  end
end
