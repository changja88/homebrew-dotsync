class Dotsync < Formula
  ...
  url "https://github.com/changja88/homebrew-dotsync/archive/refs/tags/v0.1.5.tar.gz"
  sha256 "0119ebac7713702617985622e19eb1da34772d8646983503bffbf653aea4790e"
  license "MIT"
  ...
  test do
    assert_match "dotsync 0.1.5", shell_output("#{bin}/dotsync --version")
  end
end
