class Dotsync < Formula
  ...
  url "https://github.com/changja88/homebrew-dotsync/archive/refs/tags/v0.1.8.tar.gz"
  sha256 "d017c7cc98c4ce1000576b45bfd3c0ad9ba9ee1e16c753e601507d4a36cb9824"
  license "MIT"
  ...
  test do
    assert_match "dotsync 0.1.8", shell_output("#{bin}/dotsync --version")
  end
end
